...
import 'package:bloc_clean_coding/shared/storage/local_storage.dart';
import 'package:bloc_clean_coding/features/views.dart';
...
class SessionController {
  ...
  Future<void> logout(BuildContext context) async {
    try {
      ...
      MyNavigationService.pushAndRemoveAll(const SplashView());
    } catch (e) {
