...
import 'package:bloc_clean_coding/core/app_exceptions.dart';
import 'package:bloc_clean_coding/core/utils/my_logger.dart';
import 'package:bloc_clean_coding/configs/app_url.dart';
import 'package:bloc_clean_coding/shared/widgets/dialog.dart';
  ...
  Future<dynamic> postApiResponse(
    ...
    if (files != null && files.isNotEmpty) {
      ...
      for (var uploadFile in files) {
        ...
        final fileExtension =
            uploadFile.file.path.split('.').last.toLowerCase();
