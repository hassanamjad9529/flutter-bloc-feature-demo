...
import '../../core/services/session_manager/session_controller.dart'; // Importing session controller for managing user session
...
class SplashServices {
  ...
  void checkAuthentication(BuildContext context) async {
    SessionController().getUserToken().then((value) async {
      if (SessionController().token != null) {
        Timer(
